        ...
        <>
            <form action="" onSubmit={entry}>
                <div className='card-c'>
                    <h1>Complete form with create,remove,delete but update is coming soon</h1>
            ...
            <button onClick={updatedata} style={{ width: '30%', margin: '0 0 5px 500px', borderRadius: '20px', backgroundColor: 'chartreuse' }} >Clear All</button>
        </>
    )
}
